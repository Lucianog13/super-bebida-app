...
(function (root, factory) {
  ...
  function addItem(cart, producto, cantidad = 1, sabor = "", precioSabor = null, precioAnteriorSabor = null) {
    ...
    if (idx >= 0) {
      ...
      items.push({
        ...
        precioAnterior: precioAnteriorSabor != null ? precioAnteriorSabor : (producto.precioAnterior || null),
